...
REPOOUTPUT=$(curl -k -u $TL_USER:$TL_PASS \
  ...
  https://$TL_CONSOLE/api/v1/coderepos?id=se-cloud-emea-demo%2Fgbaileymcewa1430-evil.petclinic&limit=15&offset=0&project=Central+Console&reverse=true&sort=vulnerabilityRiskScore)
